				...
				<div class="row pb-60 pb-xs-40">
					<div class="col-md-8 offset-md-2">
						<div class="sec_hedding text-center">
							...
							<p>
								We are one of the grayes company who provide the cleaning services in the world.We provide secure,high quality servise to all kind of customers
							</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="solution_box about_new">
							...
							<h4>Why Choose Us</h4>
							<p>
								We are world no one cleaning servise company.
							</p>
					...
					<div class="col-lg-4 mt-sm-30 mt-xs-30">
						<div class="solution_box about_new">
							...
							<h4>Our Mission</h4>
							<p>
								Provide high quality,secure and complete service to the all.
							</p>
					...
					<div class="col-lg-4 mt-sm-30 mt-xs-30">
						<div class="solution_box about_new">
							...
							<h4>What We Do</h4>
							<p>
								We do home cleaning,commercial cleaning also hospital cleaning services.
							</p>
				...
				<div class="row">
					<div class="col-lg-6 d-flex align-items-center">
						...
						<div>
							...
							<p>
								We are the greates cleaning service provided company in the world.
							</p>
						</div>
				...
				<div class="row pb-60 pb-xs-40">
					<div class="col-md-8 offset-md-2">
						<div class="sec_hedding text-center">
							...
							<span class="b-border"></span>
							<p>
								We came to the industry 10 years ago.So we have more experiance and we have clevere managemnt and high quality cleaning team.
							</p>
						</div>
					</div>
				</div>
						...
						<div class="col-md-3">
							<div class="bullet_round last_round">
								...
								<div class="second_righ">
									...
									<strong class="mr-top">2017</strong>
									<div class="hover_cont">
										<h3>Special cleaning for the avoid COVID-19 <b>(NEW)</b></h3>
										<p>
										We started here.
										</p>
										<span class="conner"></span>
				...
				<div class="row text-center mb-40 mb-xs-30">
					<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
						<div class="sec_hedding text-center">
							...
							<span class="b-border"></span>
							<p>
								Here some quotes of our satisfied customers
							</p>
						</div>
					</div>
				</div>
						...
						<div class="textimonial_show">
							<div class="testimonial-block cyan-background">
								<figure class="testimonial-img">
									<img class="img-circle img-border" src="<?php echo $products['image'];?>" alt="">
								</figure>
								<h3 class="testimonial-author"><?php echo $products['name'];?></h3>
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-4 mt-sm-30 mt-xs-30 footer-subscribe">
						...
						<form action="reg2.php" metthod="post">
							...
							<button class="btn-text" name="submit">
