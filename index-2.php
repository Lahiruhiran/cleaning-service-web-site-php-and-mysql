			...
			<div class="container">
				<div class="row pb-30">
					...
					<div class="col-md-8 mt-xs-30 text-center text-md-left">
						<p>
							We are the one of the greate company who provide cleaning service.We provide high quality,secure and attractive services for the all kind of ceaning areas.
						</p>
						<p>
							Be with us & get our high quality service.
						</p>
					</div>
				</div>
					...
					<div class="col-lg-8">
						<div class="email_gardener">
							...
							<div class="text_heading mb-30 light-color">
								<p>
									Pleace make an Email when you in a trouble???
								</p>
							</div>
							<div class="email_fill">
								<form action="reg.php" method="post">
									<div class="form-field">
										<input class="input-sm" id="email" type="email" name="email" placeholder="Your Email">
					...
					<div class="col-lg-3 col-md-6">
						<div class="team_box img-scale">
							...
							<div class="social_team">
								<ul>
									<li>
										<a href="<?php echo $products['fb'];?>"><i class="fa fa-facebook"></i></a>
									</li>
									<li>
										<a href="<?php echo $products['tw'];?>"><i class="fa fa-twitter"></i></a>
									</li>
									<li>
										<a href="<?php echo $products['ln'];?>"><i class="fa fa-linkedin"></i></a>
									</li>
									<li>
										<a href="<?php echo $products['yt'];?>"><i class="fa fa-youtube"></i></a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="row text-center light-color mb-40 mb-xs-30">
					<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
						<div class="section-title_home">
							...
							<span class="b-line"></span>
							<p>
								we are the best cleaning firm in the world
							</p>
						</div>
					</div>
				</div>
				...
				<div class="row text-center mb-40 mb-xs-30">
					<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
						<div class="section-title_home">
							...
							<span class="b-line"></span>
							<p>
								We complete diffrent types of  projects.
							</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-8 offset-lg-2">
						<ul class="container-filter categories-filter">
							...
							<li>
								<a class="categories" data-filter=".branding">Commercial Cleaning</a>
							</li>
							<li>
								<a class="categories" data-filter=".design">Carpet Cleaning</a>
							</li>
							<li>
								<a class="categories" data-filter=".photo">House Cleaning</a>
							</li>
							<li>
								<a class="categories" data-filter=".coffee">Office and House Cleaning</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="row container-grid nf-col-3">
					...
					<div class="nf-item branding coffee spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								<a href="404.php" class="project_links same_style"> <i class="fa fa-link"> </i> </a>
				...
				<div class="row text-center light-color mb-40 mb-xs-30">
					<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
						<div class="section-title_home">
							...
							<span class="b-line"></span>
							<p>
								Some quotes about our satisfied customers.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 footer_logo">
						<a href="index-2.php"><img src="assets/images/des.jpeg" alt="Logo" width="222" height="75" alt=""></a>
						<p>
							we are the best cleaning company in the world.
						</p>
						<ul>
							<li>
